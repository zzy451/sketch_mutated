...
class LLMProposalEngine:
    ...
    def _prefer_single_tree_for_phase(self, phase: str) -> bool:
    ...
    def _default_single_tree_target(self, phase: str, report: dict):
        target = str(self.cfg.get("llm_single_tree_target", "update") or "update").strip().lower()
    ...
    def _build_prompt(self, phase: str, report: dict, repair_feedback: str = ""):
        use_single_tree = self._prefer_single_tree_for_phase(phase)
