...
# ---- init_dex (evolved) ----
def init_dex(e):
    return list_3(1, False, 0, select_hash(1, e), safe_mod(safe_add(3, safe_sub(select_hash(0, e), select_hash(2, e))), 102), 102, select_hash(0, e), select_hash(2, e), select_hash(0, str_slice(e, 3, 8)))
...
def query(e):
    return base_sel(8, query_date(str_slice(str_slice(e, False, True), False, False), 0), query_date(e, 1), query_date(e, 2))
